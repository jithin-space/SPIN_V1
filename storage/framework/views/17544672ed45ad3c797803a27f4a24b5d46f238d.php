<?php $__env->startSection('page_heading', 'Create IEP'); ?>
<?php $__env->startSection('section'); ?>
  <form  method="POST" action="<?php echo e(route('students.iep.store',[\Auth::user()->roles()->first()->name,$data['sid']])); ?>" id="form1">
