<?php $__env->startSection('page_heading','Student Feedbacks'); ?>
              ...
              <div class="panel panel-danger">
                  ...
                  <div class="panel-body">
                      ...
                      <div class="models--actions">
                          <a class="btn btn-labeled btn-success" href="<?php echo e(route('students.feedback.create',[\Auth::user()->roles()->first()->name,$student->_id])); ?>"><span class="btn-label"><i class="fa fa-plus"></i></span><?php echo e('Add Info'); ?></a>
                      </div>
...
<div class="container">
  <div class="row">
          ...
          <div class="model--actions">
              <a class="btn btn-labeled btn-success" href="<?php echo e(route('students.feedback.create',[\Auth::user()->roles()->first()->name,$student->_id])); ?>"><span class="btn-label"><i class="fa fa-plus"></i></span><?php echo e('Add New'); ?></a>
          </div>
                     ...
                     <div class="col-md-10 col-md-offset-1">
                      ...
                      <div class="panel panel-default">
                         <div class="panel-heading">
                              ...
                              <?php echo e($feedback->created_by); ?> on<a data-toggle="collapse" data-parent="#accordion1" href="#collapse<?php echo e($feedback->_id); ?>"> <?php echo e(Carbon\Carbon::parse($feedback->created_at)->format('F j, Y')); ?></a>

                          </div>
                         <div id="collapse<?php echo e($feedback->_id); ?>" class="panel-collapse collapse">
                           <div class="panel-body">
                             <div class="row">
                               <div class="col-md-6">
                                 <div class="panel panel-primary">
                                    ...
                                    <div class="panel-footer label-primary">
                                        ...
                                        <form action="<?php echo e(route('students.feedback.destroy',[\Auth::user()->roles()->first()->name,$student->_id,$feedback->_id])); ?>" method="post" class="delete">
                                          <input type="hidden" name="_method" value="DELETE">
                                          <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                          <a href="<?php echo e(route('students.feedback.edit',[\Auth::user()->roles()->first()->name,$student->_id,$feedback->_id])); ?>"  type="button" class="btn btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-pencil"></i></span><?php echo e('Edit'); ?></a>
                                ...
                                <div class="col-md-6">
                                  <div class="panel panel-default">
                                     <div class="panel-heading">Comments <span class="badge pull-right"><?php echo e($feedback->comments()->count()); ?></span></div>
                                       <div class="panel-body">
                                         <div class="actionBox">
                                       ...
                                       <div class="panel-footer">
                                         <form class="form" action="<?php echo e(route('students.feedback.comment.store',[\Auth::user()->roles()->first()->name,$student->_id,$feedback->_id])); ?>" method="POST">
                                           <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
