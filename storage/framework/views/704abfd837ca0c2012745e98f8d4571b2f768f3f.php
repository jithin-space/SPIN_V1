<?php $__env->startSection('page_heading', 'Add General Information'); ?>
...
<?php echo form_row($form->Student_Number); ?>

<div class="form form-group" style="display:inline-block;">
<div style="display:inline-block;float:left;"><?php echo form_row($form->Disabilities); ?></div>&nbsp;&nbsp; OR &nbsp;&nbsp;
