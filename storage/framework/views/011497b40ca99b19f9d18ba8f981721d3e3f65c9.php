<?php $__env->startSection('page_heading','Student IEP'); ?>
   ...
   <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
         <div class="panel-heading">
            <h4>IEP (<?php echo e($ieps->status); ?>)</h4>
         </div>
         <div class="panel-body">
                     <table class="table well">
                        <tr class="row">
                           <td class="col-md-4 alert warning">Objective Description</td>
                           <td class="col-md-8 alert info"><?php echo e($ieps->description); ?></td>
                        </tr>
                        <tr class="row">
                           <td class="col-md-4 alert success">Long Term Objective</td>
                           <td class="col-md-8 alert warning"><?php echo e($ieps->lto_description); ?></td>
                        </tr>
                        <tr class="row">
                           <td class="col-md-4 alert danger">Goal Area</td>
                           <td class="col-md-8 alert success"><?php echo e($ieps->goal_area_description); ?></td>
                        </tr>
                        <tr class="row">
                        ...
                        <tr class="row">
                           <td class="col-md-4">
                             <button data-toggle="collapse" data-target="#home<?php echo e($ieps->_id); ?>" class="btn btn-primary">Comments&nbsp;&nbsp;<span class="badge"><?php echo e(count($ieps->comments)); ?></span></button>
                           </td>
                           <td class="col-md-8">
                             <div class="pull-right">
                             <form action="<?php echo e(route('students.iep.destroy',[\Auth::user()->roles()->first()->name,$student->_id,$ieps->_id])); ?>" method="post">
                                <input type="hidden" name="_method" value="DELETE">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                <a class="btn btn-labeled btn-default" href="<?php echo e(route('students.iep.edit',[\Auth::user()->roles()->first()->name,$student->_id,$ieps->_id])); ?>"><span class="btn-label"><i class="fa fa-pencil"></i></span><?php echo e('edit'); ?></a>
                     ...
                     <div id="home<?php echo e($ieps->_id); ?>" class="collapse">
                        <div class="panel panel-default">
                           ...
                           <div class="panel-footer">
                              <form id="test" class="" action="<?php echo e(route('students.iep.comment.store',[\Auth::user()->roles()->first()->name,$student->_id,$ieps->_id])); ?>" method="POST">
                                 <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
...
<?php echo $__env->make('student_layout1',['student'=>$data[0]], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>