<?php $__env->startSection('page_heading', 'Add Guardian Info'); ?>
<?php $__env->startSection('section'); ?>

<?php echo form_start($form); ?>

<div class="collection-container" data-prototype="<?php echo e(form_row($form->guardian->prototype())); ?>">
    <?php echo form_row($form->guardian); ?>
