<?php $__env->startSection('page_heading', 'Create Background Info'); ?>
<?php $__env->startSection('section'); ?>
  ...
  <a href="#myModal3" data-toggle="modal"  class="ddd btn btn-success">Add New Info Type</a>
    ...
    <button type="submit" id="create" class="btn btn-labeled btn-success"><span class="btn-label"><i class="fa fa-plus"></i></span><?php echo e('save'); ?></button>
